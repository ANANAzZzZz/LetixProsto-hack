package suai.vladislav.letixprosto.util
...
open class DataTime(
    ...
    fun getStartWeek() = DataTime(LocalDateTime(year, mouth, dayOfMonth, hour, minute)
        .toInstant(TimeZone.currentSystemDefault())
        .minus(dayOfWeek - 1, DateTimeUnit.DAY, TimeZone.currentSystemDefault())
        .toLocalDateTime(TimeZone.currentSystemDefault()))
    ...
    fun getLocalDate() = LocalDate(year, mouth, dayOfMonth)
